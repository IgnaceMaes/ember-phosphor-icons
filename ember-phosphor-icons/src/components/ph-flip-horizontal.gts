...
interface PhFlipHorizontalSignature {
  Args: {
...
export default class PhFlipHorizontal extends Component<PhFlipHorizontalSignature> {
  get weight() {
