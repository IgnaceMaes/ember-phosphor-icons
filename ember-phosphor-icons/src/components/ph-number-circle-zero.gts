...
interface PhNumberCircleZeroSignature {
  Args: {
...
export default class PhNumberCircleZero extends Component<PhNumberCircleZeroSignature> {
  get weight() {
