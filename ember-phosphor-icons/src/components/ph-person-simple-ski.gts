...
interface PhPersonSimpleSkiSignature {
  Args: {
...
export default class PhPersonSimpleSki extends Component<PhPersonSimpleSkiSignature> {
  get weight() {
