...
interface PhStarAndCrescentSignature {
  Args: {
...
export default class PhStarAndCrescent extends Component<PhStarAndCrescentSignature> {
  get weight() {
