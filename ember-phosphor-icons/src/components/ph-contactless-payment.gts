...
interface PhContactlessPaymentSignature {
  Args: {
...
export default class PhContactlessPayment extends Component<PhContactlessPaymentSignature> {
  get weight() {
