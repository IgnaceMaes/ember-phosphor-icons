...
interface PhApplePodcastsLogoSignature {
  Args: {
...
export default class PhApplePodcastsLogo extends Component<PhApplePodcastsLogoSignature> {
  get weight() {
