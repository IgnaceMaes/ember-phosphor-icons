...
interface PhDropHalfBottomSignature {
  Args: {
...
export default class PhDropHalfBottom extends Component<PhDropHalfBottomSignature> {
  get weight() {
