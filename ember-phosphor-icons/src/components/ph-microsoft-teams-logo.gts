...
interface PhMicrosoftTeamsLogoSignature {
  Args: {
...
export default class PhMicrosoftTeamsLogo extends Component<PhMicrosoftTeamsLogoSignature> {
  get weight() {
