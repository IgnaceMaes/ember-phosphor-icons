...
interface PhCrosshairSimpleSignature {
  Args: {
...
export default class PhCrosshairSimple extends Component<PhCrosshairSimpleSignature> {
  get weight() {
