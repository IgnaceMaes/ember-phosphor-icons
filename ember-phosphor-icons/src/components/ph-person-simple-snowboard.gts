...
interface PhPersonSimpleSnowboardSignature {
  Args: {
...
export default class PhPersonSimpleSnowboard extends Component<PhPersonSimpleSnowboardSignature> {
  get weight() {
