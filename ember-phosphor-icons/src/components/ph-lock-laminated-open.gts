...
interface PhLockLaminatedOpenSignature {
  Args: {
...
export default class PhLockLaminatedOpen extends Component<PhLockLaminatedOpenSignature> {
  get weight() {
