...
interface PhMicrosoftWordLogoSignature {
  Args: {
...
export default class PhMicrosoftWordLogo extends Component<PhMicrosoftWordLogoSignature> {
  get weight() {
