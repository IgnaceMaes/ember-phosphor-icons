...
interface PhPersonSimpleHikeSignature {
  Args: {
...
export default class PhPersonSimpleHike extends Component<PhPersonSimpleHikeSignature> {
  get weight() {
