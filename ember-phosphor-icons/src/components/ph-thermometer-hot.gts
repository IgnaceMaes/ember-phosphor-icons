...
interface PhThermometerHotSignature {
  Args: {
...
export default class PhThermometerHot extends Component<PhThermometerHotSignature> {
  get weight() {
