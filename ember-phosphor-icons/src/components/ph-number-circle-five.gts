...
interface PhNumberCircleFiveSignature {
  Args: {
...
export default class PhNumberCircleFive extends Component<PhNumberCircleFiveSignature> {
  get weight() {
