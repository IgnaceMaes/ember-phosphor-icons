...
interface PhCodesandboxLogoSignature {
  Args: {
...
export default class PhCodesandboxLogo extends Component<PhCodesandboxLogoSignature> {
  get weight() {
