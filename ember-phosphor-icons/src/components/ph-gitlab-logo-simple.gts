...
interface PhGitlabLogoSimpleSignature {
  Args: {
...
export default class PhGitlabLogoSimple extends Component<PhGitlabLogoSimpleSignature> {
  get weight() {
