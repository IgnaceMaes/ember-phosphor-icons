...
interface PhNumberCircleThreeSignature {
  Args: {
...
export default class PhNumberCircleThree extends Component<PhNumberCircleThreeSignature> {
  get weight() {
